...
def parse_args():
    ...
    parser.add_argument('--img', default='/data1/lkh/dataset/ShipRSImageNet_V1/VOC_Format/val_images/004503.png',help='Image file')
    parser.add_argument('--config', default='configs/retinanet/retinanet_r50_fpn_1x_coco.py',help='Config file')
    parser.add_argument('--checkpoint', default='/data1/lkh/dataset/ShipRSImageNet_V1/VOC_Format/val_images/004503.png',help='Checkpoint file')
    parser.add_argument(
        '--method',
        default='gradcam',
...
def main():
    ...
    for image_path in images:
        ...
        image_with_bounding_boxes = det_cam_visualizer.show_cam(
            image, bboxes, labels, grayscale_cam, False)
