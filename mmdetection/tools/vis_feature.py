...
device = 'cuda'
config = r"/data1/lkh/mmdet/configs/mask_rcnn/mask_rcnn_r50_fpn_1x_coco.py"
ckpt = r"/data1/lkh/mmdet/mask_rcnn_r50_fpn_1x_coco_20200205-d4b0c5d6.pth"
img = r"/data1/lkh/mmdet/demo/demo.jpg"
score_thr = 0.5
...
model.bbox_head.fc_cls.register_forward_hook(hook_fn)
