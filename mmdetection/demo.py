...
out_file= 'test_show/'
coco = COCO(json_file)
config_file = 'work_dirs/detectors_cascade_rcnn_r50_1x_coco/detectors_cascade_rcnn_r50_1x_coco.py'
checkpoint_file = 'work_dirs/detectors_cascade_rcnn_r50_1x_coco/epoch_10.pth'
