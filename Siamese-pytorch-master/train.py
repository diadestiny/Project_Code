...
def list_txt(txt,paths,labels):
    with open(txt, 'w') as f:
        for pa,la in zip(paths,labels):
            f.write(str(pa)+" "+str(la) + '\n')
def txt_list(txt):
    f = open(txt, "r")
    lines = f.readlines()
    path_list=[]
...
if __name__ == "__main__":
    ...
    # list_txt("train.txt",train_lines,train_labels)
    # list_txt("val.txt", val_lines,val_labels)
    train_lines,train_labels=txt_list("train.txt")
    val_lines, val_labels = txt_list("val.txt")
