...
#     count = log.total
#     common_schema = AnalysisSchema(many=True)  # 用已继承ma.ModelSchema类的自定制类生成序列化类
#     output = common_schema.dump(log_items)  # 生成可序列化对象
#     return table_api(data=output,count=count)
#     # return table_api(
#     #     data=model_to_dicts(
